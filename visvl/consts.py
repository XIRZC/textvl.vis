...
#textvqa_ocr_box {background-color: rgba(108, 32, 235, 0.3)}
...
#textvqa_contrast_box4 {background-color: rgba(255, 226, 63, 0.3)}
#textvqa_contrast_box5 {background-color: rgba(190, 37, 56, 0.3)}
#textvqa_contrast_box6 {background-color: rgba(190, 37, 56, 0.3)}
#textcaps_anno_box {background-color: rgba(37, 190, 45, 0.3)}
#textcaps_ocr_box {background-color: rgba(108, 32, 235, 0.3)}
...
#textcaps_contrast_box4 {background-color: rgba(255, 226, 63, 0.3)}
#textcaps_contrast_box5 {background-color: rgba(190, 37, 56, 0.3)}
#textcaps_contrast_box6 {background-color: rgba(190, 37, 56, 0.3)}
"""
